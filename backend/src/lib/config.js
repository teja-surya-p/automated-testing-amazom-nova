...
export const config = {
  ...
  uiuxDefaultTimeBudgetMs: Number(process.env.UIUX_TIME_BUDGET_MS ?? 300_000),
  uiuxQuickTimeBudgetMs: Number(process.env.UIUX_QUICK_TIME_BUDGET_MS ?? 600_000),
  uiuxFullTimeBudgetMs: Number(process.env.UIUX_FULL_TIME_BUDGET_MS ?? 1_800_000),
  uiuxFullAllTimeBudgetMs: Number(process.env.UIUX_FULL_ALL_TIME_BUDGET_MS ?? 3_600_000),
